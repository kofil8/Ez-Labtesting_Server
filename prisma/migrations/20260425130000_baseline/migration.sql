...
-- CreateEnum
CREATE TYPE "PaymentStatus" AS ENUM ('PENDING', 'PROCESSING', 'SUCCEEDED', 'FAILED', 'CANCELLED', 'REFUNDED', 'PARTIALLY_REFUNDED', 'REQUIRES_ACTION');

-- CreateEnum
CREATE TYPE "PaymentMethodType" AS ENUM ('CARD', 'ACH');

-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('CART', 'PENDING_PATIENT_INFO', 'PENDING_PAYMENT', 'PAYMENT_FAILED', 'PAID', 'AWAITING_USER_CONFIRMATION', 'READY_FOR_LAB_SUBMISSION', 'LAB_SUBMISSION_IN_PROGRESS', 'LAB_SUBMISSION_FAILED', 'MANUAL_REVIEW_REQUIRED', 'SUBMITTED_TO_LAB', 'REQUISITION_READY', 'COMPLETED', 'CANCELLED');

-- CreateEnum
CREATE TYPE "AccessSubmissionStatus" AS ENUM ('NOT_SUBMITTED', 'PENDING', 'SUBMITTED', 'FAILED', 'CANCELLED');

-- CreateEnum
CREATE TYPE "RequisitionStatus" AS ENUM ('PENDING', 'RECEIVED', 'FILE_STORED', 'READY', 'FAILED', 'CANCELLED');
...
-- CreateEnum
CREATE TYPE "SupportTicketStatus" AS ENUM ('OPEN', 'AWAITING_ADMIN', 'IN_PROGRESS', 'WAITING_FOR_CUSTOMER', 'RESOLVED', 'CLOSED');
...
CREATE TABLE "Test" (
    ...
    "description" TEXT,
    "testImageUrl" VARCHAR(500),
    "shortDescription" VARCHAR(500),
    "setUpSchedule" VARCHAR(500)[] DEFAULT ARRAY[]::VARCHAR(500)[],
    "categoryId" UUID NOT NULL,
    "specimenType" VARCHAR(100),
    "baseTurnaroundDays" SMALLINT,
    "isPanel" BOOLEAN NOT NULL DEFAULT false,
    "cptCode" VARCHAR(20)[] DEFAULT ARRAY[]::VARCHAR(20)[],
...
CREATE TABLE "DrawCenter" (
    ...
    "isActive" BOOLEAN NOT NULL DEFAULT true,
    "isVisible" BOOLEAN NOT NULL DEFAULT true,
    "normalizedSearchText" VARCHAR(1000),
    "metadata" JSONB,
    "deletedAt" TIMESTAMP(3),
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "CartItem" (
    ...
    "currency" CHAR(3) NOT NULL DEFAULT 'USD',
    "baseRetailPrice" DECIMAL(10,2) NOT NULL DEFAULT 0.00,
    "effectiveUnitPrice" DECIMAL(10,2) NOT NULL DEFAULT 0.00,
    "metadata" JSONB,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "Order" (
    ...
    "labSubmissionPayloadJson" JSONB,
    "labSubmissionResponseJson" JSONB,
    "labSubmissionErrorCode" VARCHAR(100),
    "labSubmissionErrorMessage" TEXT,
    "customerEmailSnapshot" VARCHAR(255),
    "customerPhoneSnapshot" VARCHAR(20),
    "pricingSnapshotJson" JSONB,
    "idempotencyKey" TEXT,
    "labSubmissionAttempts" INTEGER NOT NULL DEFAULT 0,
    "lastLabSubmissionAttemptAt" TIMESTAMP(3),
    "lastPaymentEventId" VARCHAR(100),
    "paidAt" TIMESTAMP(3),
...
CREATE TABLE "PromoCode" (
    ...
    "pricingStrategy" "PromoPricingStrategy" NOT NULL DEFAULT 'PRICING_FLOOR',
    "status" "PromoCodeStatus" NOT NULL DEFAULT 'DRAFT',
    "discountValue" DECIMAL(10,2) NOT NULL DEFAULT 0.00,
    "minOrder" DECIMAL(10,2),
    "minimumMarginAmount" DECIMAL(10,2),
...
CREATE TABLE "OrderPromoCode" (
    ...
    "appliedCode" VARCHAR(50) NOT NULL,
    "discountType" "DiscountType" NOT NULL,
    "discountValue" DECIMAL(10,2) NOT NULL DEFAULT 0.00,
    "pricingStrategy" "PromoPricingStrategy" NOT NULL DEFAULT 'PRICING_FLOOR',
    "discountAmount" DECIMAL(10,2) NOT NULL DEFAULT 0.00,
...
CREATE TABLE "OrderTrackingEvent" (
    ...
    "eventType" "OrderTrackingEventType" NOT NULL,
    "actorType" "TrackingActorType" NOT NULL DEFAULT 'SYSTEM',
    "actorId" VARCHAR(100),
...
CREATE TABLE "SupportTicket" (
    ...
    "reasonCode" "SupportTicketReasonCode" NOT NULL DEFAULT 'GENERAL_REQUEST',
    "notes" TEXT,
    "failureContextJson" JSONB,
    "assigneeUserId" UUID,
